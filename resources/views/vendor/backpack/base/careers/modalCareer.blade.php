	...
	<div class="modal-dialog">
		<div class="modal-content" style="border-radius: 7px;">
			...
			<div class="modal-body">
				<form method="POST" id="frmCareer" name="frmCareer" enctype="multipart/form-data" action="{{ url(''). "/ad/career" }}">
				{{ csrf_field() }}
						...
						<div class="row">
							<div class="col-md-12 col-sm-12 col-xs-12">
								...
								<div class="form-group ">
									...
									<textarea name="job_description" id="job_description" class="form-control my-editor"></textarea>
								</div>

								<div class="form-group ">
									<label class="control-label requiredField" for="job_requirement">
										Job Requirement
									</label>
									<textarea name="job_requirement" id="job_requirement" class="form-control my-editor"></textarea>
								</div>
								<div class="form-group ">
