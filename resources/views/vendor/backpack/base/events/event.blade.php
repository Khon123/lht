		...
		<div class="box box-default">
			<div class="box-header with-border">
				<div class="box-title">
					...
					{{-- ===========include modal========== --}}
					@include('backpack::events.modalEvent')
...
@section('after_scripts')
	<script type="text/javascript">
		...
		var url ="{{ url(config('backpack.base.route_prefix', 'admin').'/event')}}";

		{{-- post_date datepicker --}}
		$(document).ready(function(){
			var date_input = $('input[name="event_date"]');//our date in put has the name "post_date"
