	...
	<div class="modal-dialog">
		<div class="modal-content" style="border-radius: 7px;">
			<div class="modal-header">
				...
				<h2 class="modal-title" id="myModalLabel" style="color: blue;">Add New Team</h2>
			</div>
							...
							<div class="row">
								<div class="col-md-12 col-sm-12 col-xs-12">
										...
										<div class="form-group ">
											...
											<textarea class="form-control my-editor" cols="40" id="detial" name="detial" rows="5" ></textarea>
										</div>
										<div class="form-group ">
